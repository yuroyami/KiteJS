<#--
  ...
  https://yuroyami.github.io/KiteJS/ and https://github.com/yuroyami/KiteJS are substituted per repository by
...
<#macro display>
    <header class="navigation theme-dark" id="navigation-wrapper" role="banner">
        ...
        <nav class="kite-nav-links" aria-label="Kite documentation">
            <a href="https://yuroyami.github.io/KiteJS/">Guide</a>
            <a href="https://github.com/yuroyami/KiteJS">GitHub</a>
        </nav>
